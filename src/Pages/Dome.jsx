    ...
    return (
        <>
            ...
            >
                <main
                    ref={mainRef}
                    className="absolute inset-0 grid place-items-center overflow-hidden select-none bg-amber-300"
                    style={{
                        touchAction: 'none',
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            ...
                                            style={{
                                                backfaceVisibility: 'hidden',
                                                // filter: `var(--image-filter, ${grayscale ? 'grayscale(1)' : 'none'})` // This is for giving the img in black nd white
                                            }}
                                        />
                                    </div>
                                </div>
